...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        p2.setName("Joaquim");
        p2.setAdress("Rua Esquerda, 91");

        boolean resultado = d3.beforeDate(d4);
        boolean resultadoAfter = d3.afterDate(d4);
        ...
        //System.out.println("DifferenceYears: " + d1.diferenceYears(d2));
        ...
        Date.daysMonth(1, 2021);
        System.out.println("Number days of month " + month + "/" + year + ": " + (Date.daysMonth((short) month, year)));
        ...
        Number days of month 3/2021: 31
